...
class createCodeData():
    def __init__(self,tableName=None,pathName=None,savePath=None,frameWork=None,isEnum=None,lombok=None,isJPA=None,isCreateFile=None,sqlData=None):
